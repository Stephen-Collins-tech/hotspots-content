...
**Angle:** The big-5 patterns (`long_function`, `god_function`, `exit_heavy`, `complex_branching`, `deeply_nested`) appear in nearly every TS repo I've analysed. This is the anchor/overview post — it can link forward to posts 2 and 4.
