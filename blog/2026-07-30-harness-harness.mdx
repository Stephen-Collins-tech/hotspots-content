---
title: "harness/harness's pull request UI carries the highest activity risk — 5 functions to address first"
...
The exit-heavy pattern compounds this: multiple early returns scattered across closures mean coverage tools will report line coverage without actually exercising all decision points. Combined with a single author touching this file in 90 days (`author_count_90d: 1`), the institutional knowledge required to safely modify this hook is concentrated in one person.
