---
title: "pip's vendored code carries the highest structural debt — 5 functions frozen for months"
titleSeo: "pip code health: vendored parsing functions lead technical debt and refactoring priorities"
description: "An analysis of pypa/pip finds its riskiest functions sitting untouched for over four months inside vendored rich and urllib3 code, plus one dormant-but-actively-owned hotspot in pip's own wheel installer."
