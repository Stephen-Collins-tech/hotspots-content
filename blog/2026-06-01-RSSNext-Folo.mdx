---
title: "Folo's UI and integration layer carries the highest activity risk — 5 functions to address first"
...
This is the top-ranked function in the repository by activity_risk, scoring 16.07. A cyclomatic complexity of 47 means 47 independent execution paths through a single function — each one a potential bug surface and a required test case. The max nesting depth of 5 compounds that: the deepest branches are nested five levels deep, which in TypeScript means reasoning about type-narrowed state accumulated across multiple layers of conditionals simultaneously.
