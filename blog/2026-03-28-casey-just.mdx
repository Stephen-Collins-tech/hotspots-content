...
qaSection:
  ...
  - question: "Is just actively maintained?"
    answer: "The data strongly suggests it is: all five top-ranked critical functions are in the fire quadrant, meaning they combine high structural complexity with high recent commit activity — `parse_ast` has a recent commit activity of 18.13 and `lex_line_start` scores 18.14, indicating the core parsing and lexing pipeline is seeing frequent, ongoing changes at commit 873c6a0."
