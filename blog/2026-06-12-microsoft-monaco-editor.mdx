...
|------|----------|------|------------|------|----|----|-----|---------------|
| 1 | `tokenize` | `src/languages/features/json/tokenization.ts` | 13.97 | critical | 36 | 3 | 10 | 0 |
| 2 | `toLoaderConfig` | `website/src/website/pages/playground/SettingsModel.ts` | 12.59 | critical | 24 | 2 | 8 | 0 |
| 3 | `typeToTypeScript` | `monaco-lsp-client/generator/index.ts` | 12.52 | critical | 45 | 2 | 3 | 0 |
| 4 | `toSymbolKind` | `src/languages/features/common/lspLanguageFeatures.ts` | 10.45 | critical | 38 | 1 | 0 | 0 |
| 5 | `toCompletionItemKind` | `src/languages/features/common/lspLanguageFeatures.ts` | 10.37 | critical | 38 | 1 | 0 | 0 |
