...
tags:
  ...
  - "machine-learning"
draft: false
introContent: "Transformer embeddings on source code improved defect ranking on exactly the repos where git history had already failed — and added near-zero or negative signal everywhere else. Here's what that conditional looks like in practice."
---
