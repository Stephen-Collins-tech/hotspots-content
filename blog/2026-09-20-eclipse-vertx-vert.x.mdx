---
title: "vert.x's TLS and codec layers carry the highest activity risk — 5 functions to address first"
...
Out of four risk quadrants, 1,069 functions in vert.x sit in structural debt — complex but dormant — versus 397 in active fire-quadrant risk. That ratio is the headline: nearly three times as many functions are ticking time bombs as are live regression risks. The five below are the ones I'd put in front of a reviewer first, in the order the data ranks them.
