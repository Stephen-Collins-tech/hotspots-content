---
title: "Phaser's tween, renderer, and tilemap layers carry the highest activity risk — 5 functions to address first"
...
### `GraphicsWebGLRenderer` — GraphicsWebGLRenderer.js
...
### `IsometricCullTiles` — IsometricCullTiles.js
