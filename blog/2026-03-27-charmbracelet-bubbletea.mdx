...
- `eventLoop` in tea.go (CC 39, fan-out 30, risk score 15.9) is the single highest-priority target: add characterization tests covering its execution paths before the next commit touches it.
