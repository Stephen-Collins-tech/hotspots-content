---
title: "type-challenges build scripts show critical structural debt: three god functions with 25+ callees each dominate the automation layer"
...
Type-challenges' build and automation layer is under structural stress. Three functions in the scripts/ directory—generatePlayground, an anonymous handler in issue-pr.ts, and an anonymous handler in labeling.ts—all hit critical activity_risk (10.66–11.57) and exhibit god-function patterns with fan-out of 10–25 distinct function calls each. Across 140 total functions, 3 are critical and 4 more are high-band, with stale_complex being the dominant antipattern (4 occurrences), suggesting these functions have been repeatedly modified despite their structural complexity.
