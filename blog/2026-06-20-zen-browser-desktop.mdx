...
description: "Five critical-band functions in zen-browser/desktop's tab management, split-view, and drag-and-drop layer are all in the 'fire' quadrant — structurally complex and actively changing within the last 7 days — with activity-weighted risk scores up to 18.18."
