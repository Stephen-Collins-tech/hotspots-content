---
title: "langextract's extraction layer carries the highest activity risk — 4 functions to address first"
...
|---|---|---|---|---|---|
| `_infer_batch_one_job` | langextract/providers/openai_batch.py | 16.9 | 43 | 4 | 31 |
| `extract` | langextract/extraction.py | 16.8 | 62 | 4 | 33 |
| `infer` | langextract/providers/openai.py | 16.2 | 36 | 4 | 18 |
| `download_text_from_url` | langextract/io.py | 16.0 | 31 | 6 | 21 |
| `infer_batch` | langextract/providers/gemini_batch.py | 15.2 | 36 | 3 | 34 |
