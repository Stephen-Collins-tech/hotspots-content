...
qaSection:
  ...
  - question: "Is docsify actively maintained?"
    answer: "The structural data shows one actively-changing hotspot — `Render` in `src/core/render/index.js` — with a risk score of 13.4, indicating the core render layer is seeing active development. The majority of top-ranked hotspots, however, are high-complexity areas that have accumulated structural risk without recent churn — the YAML front-matter parser being the primary example."
