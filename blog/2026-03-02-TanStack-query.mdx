...
description: "experimental_createQueryPersister in createPersister.ts tops TanStack/query's activity-risk rankings with fan-out of 27 and nesting depth of 6, driven by a recent commit activity of 15.79 — making it a live regression risk, not a cleanup backlog item."
...
qaSection:
  ...
  - question: "Is TanStack/query actively maintained?"
    answer: "Yes — the activity scores in this analysis are driven by recent, frequent commits. The top hotspot carries a recent commit activity of 15.79 and even the fifth-ranked function scores 14.53, indicating that multiple subsystems are seeing sustained development activity, not just occasional patches."
