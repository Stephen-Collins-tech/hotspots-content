...
description: "Two functions in xxl-job's CronExpression.java — storeExpressionVals and getTimeAfter — combine CC 37, nesting depth up to 8, and high recent commit activity levels, making them live regression risks in the job-scheduling core."
introContent: "xxl-job's cron parsing layer is its most urgent structural risk: two functions in CronExpression.java are both maximally complex and actively changing — a combination that makes every commit a potential regression"
pubDate: 2026-04-30
