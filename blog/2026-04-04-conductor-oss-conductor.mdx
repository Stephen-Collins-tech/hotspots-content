...
description: "Three files in conductor's UI layer — ui-next/src/utils/json.ts, ui/src/pages/errors/ErrorsInspector.jsx, and ui-next/src/pages/execution/WorkflowIntrospection.tsx — account for all five top hotspots, combining cyclomatic complexity as high as CC 120 with nesting depths up to ND 9 and recent commit activity levels above 17."
...
qaSection:
  ...
  - question: "Is conductor actively maintained?"
    answer: "Yes — all five top hotspots combine high structural complexity with high recent commit activity; the top function in ui-next/src/utils/json.ts carries a recent commit activity of 19.05, the highest in the dataset, indicating the UI layer in particular is under active development right now."
