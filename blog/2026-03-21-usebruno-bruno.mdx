...
language: "javascript"
report_html: "https://reports.hotspots.dev/usebruno/bruno/646c90819d6618850baa82e33b1c0806aeedbcd6/index.html"
report_json: "https://reports.hotspots.dev/usebruno/bruno/646c90819d6618850baa82e33b1c0806aeedbcd6/snapshot.json"
...
The top-ranked hotspot by activity_risk score is the function `o` in `packages/bruno-app/public/static/diff2Html.js`, with an activity_risk of 21.52 and a recent activity score of 16.21. The path `public/static/diff2Html.js` is a vendored or bundled third-party library (diff2html) served as a static asset — its metrics reflect the library's internal complexity, not bruno's own code. To exclude it from future analyses, add the following pattern to your `.hotspotsrc.json` exclude list: `"packages/bruno-app/public/static/**"`.
## Hotspot Analysis
