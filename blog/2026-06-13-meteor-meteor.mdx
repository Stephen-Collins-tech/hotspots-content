...
|------|----------|------|------|------|----------|
| 1 | `<anonymous>` | `packages/deprecated/srp/biginteger.js` | 17.69 | critical | debt |
| 2 | `resolve` | `tools/isobuild/resolver.ts` | 16.76 | critical | debt |
| 3 | `_maybeSetUpReplication` | `packages/mongo/collection/methods_replication.js` | 16.36 | critical | debt |
| 4 | `runWebAppServer` | `packages/webapp/webapp_server.js` | 16.0 | critical | debt |
| 5 | `update` | `packages/mongo/collection/methods_replication.js` | 15.7 | critical | debt |
