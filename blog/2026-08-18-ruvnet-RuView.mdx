...
External signals show a bug-fix rate of 29% across 7 total commits, with 2 authors active in the last 90 days — no bug-linked commits or reverts, which is worth noting, but the fraction of commits classified as fixes is meaningful context. This function was touched 6 times in the last 30 days and was last modified 1 day ago. That is a live regression risk.
