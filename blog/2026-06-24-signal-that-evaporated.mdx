...
**The test repos are not random.** Django, VSCode, Vue, and Django are large, high-traffic repos with long histories. The signal may be weaker on smaller repos with fewer years of fix-commit data to draw on.
