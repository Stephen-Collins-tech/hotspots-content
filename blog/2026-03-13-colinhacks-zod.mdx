...
description: "convertBaseSchema in from-json-schema.ts dominates zod's risk profile with CC 114, nesting depth 25, and a recent commit activity of 20.2 — making it a live regression risk, not just a cleanup item."
