---
title: "k3s's server and etcd layer carries its highest activity risk"
...
The `deeply_nested`, `god_function`, `long_function`, and `exit_heavy` patterns all appear here. The combination of a 0.5 bug-fix rate on the file and a nesting depth of 6 is the strongest signal in this dataset that this function deserves careful review before the next change lands.
